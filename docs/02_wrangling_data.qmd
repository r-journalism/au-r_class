...
author: "American University Data Journalism"
format:
  revealjs: 
    theme: beige
...
```
remotes::install_github("r-journalism/au-r_class", upgrade="always", quiet=TRUE)
```
...
#| eval: FALSE
#| echo: TRUE
https://r-journalism.github.io/au-r/wrangling/explore_arrange.html
```
...
#| eval: FALSE
#| echo: TRUE
https://r-journalism.github.io/au-r/wrangling/filter_select.html
```
...
#| eval: FALSE
#| echo: TRUE
https://r-journalism.github.io/au-r/wrangling/mutate_summarize.html
```
